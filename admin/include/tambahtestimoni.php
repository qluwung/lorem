                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    <a href="index.php?include=testimoni" class="btn btn-sm btn-warning float-right">
                                ...
                                <form class="form-horizontal" action="index.php?include=konfirmasi-tambah-testimoni" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="align-items-center">
                                            ...
                                            <div class="col-lg-5 col-12 pl-0">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" name="job" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="align-items-center">
                                            ...
                                            <div class="col-lg-5 col-12 pl-0">
                                                <div class="form-group">
                                                    <textarea name="detail" class="form-control form-control-user" id="" cols="30" rows="10"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="align-items-center">
