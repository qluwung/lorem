            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Artikel Detail</h1>
                                ...
                                <form class="form-horizontal" action="index.php?include=konfirmasi-tambah-artikel&" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="align-items-center">
                                            ...
                                            <div class="col-lg-5 col-12 pl-0">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" name="judul" id="" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="align-items-center">
                                            ...
                                            <div class="col-lg-5 col-12 pl-0">
                                                <div class="form-group">
                                                    <input type="date" class="form-control form-control-user" name="tanggal" id="" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="align-items-center">
                                            ...
                                            <div class="col-lg-5 col-12 pl-0">
                                                <div class="form-group">
                                                    <textarea name="text" value=" " class="form-control form-control-user" id="editor" cols="30" rows="10">
                                                                   </textarea>
                                                </div>
                                            </div>
                                        </div>
