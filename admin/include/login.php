                                ...
                                <div class="p-5">
                                    ...
                                    if (isset($_GET['pesan'])) {
                                        if ($_GET['pesan'] == "userKosong") {
                                            echo '<span class="text-danger">Maaf Username Tidak Boleh Kosong</span>';
                                            ...
                                            echo '<span class="text-danger">Maaf Username dan Password Anda Salah</span>';
                                        }
                                    }
                                    ?>


                                    <form class="user mt-2" action="index.php?include=konfirmasi-login" method="POST">
